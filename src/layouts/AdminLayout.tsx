...
export default function AdminLayout() {
  ...
  const navLinks = [
    ...
    { path: '/admin/teachers', icon: <Users className="w-5 h-5" />, label: 'Manage Teachers' },
  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans overflow-hidden print:h-auto print:overflow-visible">
      ...
      `}>
        ...
        <div className="h-16 flex items-center justify-between px-6 bg-slate-950 border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold text-white tracking-tight">Admin<span className="text-slate-400 font-medium">Panel</span></span>
          </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative w-full print:overflow-visible">
        
        {/* Topbar */}
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 z-10 shrink-0 shadow-sm print:hidden">
          <div className="flex items-center gap-3">
            <button 
            ...
            <div className="flex items-center gap-2">
               ...
               <span className="hidden sm:inline px-2 py-0.5 rounded text-[10px] font-bold bg-amber-50 text-amber-600 border border-amber-100 uppercase tracking-widest">Admin</span>
            </div>
          </div>
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-slate-50/50 w-full relative print:overflow-visible print:bg-white print:p-0">
          <Outlet />
        </main>
      </div>
